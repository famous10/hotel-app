...
const HomeScreen = ({ navigation }) => {
    ...
    const Card = ({ hotel, index }) => {
        ...
        const opacity = scrollX.interpolate({
            inputRange, outputRange: [0.7, 0, 0.7],
        });
        const scale = scrollX.interpolate({
            inputRange, outputRange: [0.8, 1, 0.8],
        });
        return (
            <TouchableOpacity
            disabled={activeCardIndex != index}
                ...
                <Animated.View style={{ ...style.card, transform: [{ scale }] }}>
                    ...
                    <View style={style.priceTag}>
                        <Text style={{ color: COLORS.white, frontSize: 20, fontWeight: 'bold' }}>₦{hotel.price}</Text>
                    </View>
                    ...
                    <View style={style.cardDetails}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            <View>
                                ...
                                <Text style={{ color: COLORS.grey, frontSize: 19 }}>{hotel.location}</Text>
                            </View>
            ...
            <View style={style.header}>
                <View style={{ paddingBottom: 15 }}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={{ fontSize: 30, fontWeight: 'bold', color: COLORS.primary }}> Lekki</Text>
                    </View>
                </View>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View>
                    <Animated.FlatList
                        ...
                        horizontal
                        data={hotels}
                        contentContainerStyle={{ paddingLeft: 20, paddingVertical: 30, paddingRight: cardWidth / 2 - 40 }}
